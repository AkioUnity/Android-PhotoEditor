...
import com.salvo.cino.base.BaseActivity;
import com.salvo.cino.filters.FilterListener;
...
//                        showSnackbar("Image changed Bitmap for Base64");
                        ...
                        try {
                            ...
                            new UploadFile().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "http://app.cinoprinter.com/api/platform/app/image_upload");
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        hideLoading();
                        showSnackbar("Failed to convert Bitmap for Base64");
                    }
                });
            } catch (IOException e) {
                e.printStackTrace();
    ...
    private class UploadFile extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            try {
                ...
                data = "id=196729&" + URLEncoder.encode("image", "UTF-8") + "=" + "data:image/png;base64," + base64;
//                Log.d("d",data);
...
//                    Log.d("d",Content.toString());
                    Log.d("d",jsonResponse.toString());
                    String status = jsonResponse.getString("code");
                    if ("1".equals(status)) {
